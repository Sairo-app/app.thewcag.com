...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "TheWCAG combines local WCAG 2.2 audits, finding-owned evidence, remediation tickets, accessible reports, retesting, and program trends on macOS and Windows.",
  path: "/",
