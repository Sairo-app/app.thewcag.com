...
export const metadata: Metadata = { title: "Privacy policy", description: "How TheWCAG handles local audit data, browser evidence, account data, AI requests, and published reports." };
