...
const COLUMNS: { heading: string; links: { href: string; label: string; icon: ReactNode }[] }[] = [
  {
    heading: "Product",
    links: [
      { href: "/accessibility-audit-software", label: "Audit workstation", icon: <AppWindowIcon size={20} /> },
      { href: "/accessibility-reporting-software", label: "Accessible reporting", icon: <FileTextIcon size={20} /> },
      ...
      { href: "/chrome-accessibility-extension", label: "Chrome extension", icon: <PuzzleIcon size={20} /> },
      ...
      { href: "/pricing", label: "Pricing", icon: <TagIcon size={20} /> },
    ],
  },
  {
    heading: "Workspace",
    links: [
      ...
      { href: "/account", label: "Account and devices", icon: <UserIcon size={20} /> },
    ],
  },
  {
    heading: "Guides",
    links: [
      { href: "/getting-started", label: "Getting started", icon: <CompassIcon size={20} /> },
      { href: "/wcag-contrast", label: "WCAG contrast", icon: <ContrastIcon size={20} /> },
      { href: "/wcag-checklist", label: "WCAG 2.2 checklist", icon: <FileCheckIcon size={20} /> },
      ...
      { href: "/privacy", label: "Privacy policy", icon: <LockIcon size={20} /> },
      { href: "/terms", label: "Terms of use", icon: <FileTextIcon size={20} /> },
    ],
  },
];
